...
function App() {
  ...
  const voices = [
    { id: 'alloy', label: 'Alloy - warm neutral adult' },
    { id: 'echo', label: 'Echo - calm adult male' },
    { id: 'fable', label: 'Fable - gentle young female' },
    { id: 'onyx', label: 'Onyx - deep adult male' },
    { id: 'nova', label: 'Nova - bright young female' },
    { id: 'shimmer', label: 'Shimmer - airy teen female' },
  ];
    ...
    try {
      ...
      if (backgroundMusic) {
        try {
          ...
          finalAudioBase64 = await musicAgent.mix(finalAudioBase64, backgroundMusic, musicVolume / 100);
          finalFormat = 'wav';
        } catch (mixError) {
      ...
      <div className="frame landing-frame">
        <div className="decorative-frame">
          ...
          <div className="hero-image-wrapper">
            <img src="image/listen-heart-ear.svg" alt="Heart and ear illustration" className="hero-image" />
          </div>
                ...
                <div className="form-grid narrow">
                  ...
                  <div className="form-section">
                    ...
                    >
                      ...
                      {musicFiles.map(file => (
                        <option key={file} value={file}>{musicLabels[file] || file.replace('.mp3', '').replace(/-/g, ' ')}</option>
                      ))}
                    </select>
                  </div>
                  ...
                  {backgroundMusic && (
                    <div className="form-section">
                      ...
                      <p className="helper-text">Scale from 0 to 100%. At 100%, music plays at half the voice volume.</p>
                      <div className="slider-container">
                        ...
                        />
                        <span className="volume-value lexend-body">{musicVolume}%</span>
                      </div>
                    </div>
                  )}
                </div>
